                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex flex-nowrap justify-content-center">
                                    <button type="button" class="btn btn-primary" data-toggle="modal" ><i class="far fa-edit"></i></button>&nbsp;
                                    <a href="#" type="button" class="btn btn-success" ><i class="fas fa-info-circle"></i></a>&nbsp;
                                    <button type="submit" class="btn btn-danger" id="delete" data-toggle="modal" data-target="#deleteDataProject"><i class="far fa-trash-alt"></i></button>
                                </div>
                            </td>
                        </tr>
                    </tbody>
                    ...
                    <form method="post" action="#" id="formAddNewStock" name="newStock">
                        ...
                        <div class="modal-body">
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control form-control-sm" id="transactionID" name="TransactionID" value="WI-<?=date('Y');?><?=random_string('numeric', 8)?>" readonly="readonly">
                          </div>
                          <div class="form-group">
